...
/*
    ...
    Rewritten by Sidi OULD SAAD HAMADY and not compatible with the PJ Naughter's code.
    http://www.hamady.org
    sidi@hamady.org
    2013
    Unicode only
...
//Misc
  ...
  inline LRESULT CallScintilla(UINT tMessage, WPARAM wParam, LPARAM lParam, BOOL bDirect = TRUE);
...
//Auto generated using the "ConvertScintillaiface.js" script
  ...
  int GetCurLineIndex(BOOL bDirect = TRUE);
